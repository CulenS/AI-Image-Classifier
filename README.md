...
### Dataset Preparation:
A dataset consisting of 3000 images each of real and AI-generated images is taken.

AI-Generated images: Web scrapped the images from a website named '_Generated Photos_'.
Real images: Extracted from the CelebA dataset.
